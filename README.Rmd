...
Note: The analysis files require user-written Stata \*.ado files.  A library of the \*.ado files is available for download from the [ddsjoberg/Stata-ado-library](https://github.com/ddsjoberg/Stata-ado-Library) repsository on github.com.    
